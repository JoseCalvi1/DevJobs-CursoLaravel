...
@section('content')
    ...
    <div class="mt-10 mb-20 md:flex items-start">
        <div class="md:w-3/5">
            <p class="block text-black-700 font-bold my-2">
            ...
            <h2 class="text-2xl mt-10 text-black-700 mb-5">Conocimientos y tecnologías</h2>
            @php
                $arraySkills = explode(",", $vacante->skills)
            @endphp

            @foreach ($arraySkills as $skill)
            <p class="inline-block border border-black-500 rounded py-2 px-8 text-black-700 font-bold my-2">
                {{ $skill }}
            </p>
            @endforeach
            ...
            <h2 class="text-2xl mt-10 text-black-700 mb-5">Descripción</h2>
